...
(
    CategoryID   int auto_increment
        primary key,
    CategoryName varchar(255) charset utf8mb3 null,
...
(
    CustomerID   int auto_increment
        primary key,
    CustomerName varchar(255) charset utf8mb3 null,
    ContactName  varchar(255) charset utf8mb3 null,
    Address      varchar(255) charset utf8mb3 null,
    City         varchar(255) charset utf8mb3 null,
    PostalCode   varchar(255) charset utf8mb3 null,
...
(
    ...
    BirthDate  date                         null,
    Photo      varchar(255) charset utf8mb3 null,
    Notes      text                         null
);
...
(
    ShipperID   int auto_increment
        primary key,
    ShipperName varchar(255) charset utf8mb3 null,
    Phone       varchar(255) charset utf8mb3 null
);
...
(
    SupplierID   int auto_increment
        primary key,
    SupplierName varchar(255) charset utf8mb3 null,
    ContactName  varchar(255) charset utf8mb3 null,
    Address      varchar(255) charset utf8mb3 null,
    City         varchar(255) charset utf8mb3 null,
    PostalCode   varchar(255) charset utf8mb3 null,
...
(
    ProductID   int auto_increment
        primary key,
    ProductName varchar(255) charset utf8mb3 null,
    SupplierID  int                          null,
    CategoryID  int                          null,
    Unit        varchar(255) charset utf8mb3 null,
    Price       float                        null,
